...
@property (nonatomic)        int  isNeedToDisplayPoint;
...
@property (nonatomic,retain,readwrite) NSMutableArray  *userDefinedPoints;
@property (nonatomic,retain,readwrite) NSMutableArray  *ShangShengGuaiDianDay;
@property (nonatomic,retain,readwrite) NSMutableArray  *XiaJiangGuaiDianDay;
...
-(void)drawXAxis;
-(void)drawYAxis;
-(void)drawLineBy:(NSArray*) points; // By Cina
